...
def package(output: Path) -> Path:
    ...
    root.find('description').text = (
        ...
        'Natural freshwater areas can blend narrow interrupted banks just outside the water. Mud requires native biome support, warm wet climate and existing soil; sandy/desert banks use sand/gravel. Water, rock, explicit coverage, roads and special terrain stay protected.\n'
        'Banks follow only locally connected ordinary freshwater. Native soil remains where sand is not part of the biome; gravel needs suitable biome terrain or nearby rock. The local effect tapers at its boundary.\n'
        'New natural freshwater shapes use native displacement with shallow margins and deeper interiors, plus the game biome/feature lakeshore material. Explicit shallow water stays shallow. Previously saved shapes and precise geometry retain their renderer; switching off surface details keeps the chosen water outline and depth.\n'
        'Start with quick suggestions or an optional local preference interview about space, mountains, water and distinctive terrain. Prepared questions adapt to previous answers and known existing water; redundant follow-ups are skipped. Review answers before requesting suggestions; questions do not call the model.\n'
        'Replacement interviews distinguish persistent tile water from drawn lakes and ponds that may be replaced. Explicit no-new-water or no-new-mountain choices take priority over scenic or defensive preferences.\n'
    ...
    with zipfile.ZipFile(archive, 'w', zipfile.ZIP_DEFLATED) as z:
        ...
        z.writestr(prefix + 'README.txt',
            ...
            '자연 효과를 켠 지형의 물가·산기슭에는 작은 바닥 구간과 해당 바이옴의 초기 식생 변화를 더합니다. 직접 지정한 채움과 비율 영역 전체·도로·특수 지형은 보존합니다. 저장된 효과 설정은 유지하며, 효과가 켜진 저장에는 새 물가 정책이 적용될 수 있습니다. 물이나 랜드마크를 자동 추가/이동하지 않으며, 사막과 특수 식생 규칙·이후 재성장은 기본 게임을 따릅니다. 미리보기는 바닥을 보여주고 풀·나무는 실제 맵에서 확인합니다.\n'
            '물가 재료는 바이옴과 주변 바닥에 맞춰 제한합니다. 연결된 담수만 거리 기준으로 쓰고, 가까운 별개 수역과 보호 영역을 따라 효과를 퍼뜨리지 않습니다. 물가 바깥 최대6칸이며 끝에서는 효과를 줄입니다.\n'
            '새 자연형 담수는 기본 게임의 윤곽 변형과 얕은 가장자리·깊은 내부, 바이옴·특징의 물가 재료를 연결합니다. 명시한 얕은 물은 얕게 유지합니다. 이전 저장과 정확한 도형은 기존 방식이며, 표면 효과를 꺼도 선택한 물 윤곽·수심은 유지합니다.\n'
            ...
            '구도 교체 문답은 타일의 강·해안·호수 특징과 채팅으로 추가한 물을 구분합니다. 타일의 물만 유지하면 직접 그린 연못은 교체되며, 풍경·방어 선호가 새 산·물 금지 조건보다 우선하지 않습니다.\n'
