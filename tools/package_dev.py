...
def package(output: Path) -> Path:
    ...
    root.find('description').text = (
        ...
        'Add local dirt paths/roads, stone roads and ancient asphalt roads/highways with Map Preview. World road links stay unchanged. No automatic bridges, tunnels or roadside buildings.\n'
    ...
    with zipfile.ZipFile(archive, 'w', zipfile.ZIP_DEFLATED) as z:
        ...
        z.writestr(prefix + 'README.txt',
            ...
            '도로는 산·물·기존 건물을 자동 철거하지 않습니다. 다리·터널·가로등·방호벽은 미지원이며, 원래 월드 도로와 교차하는 부분은 미리보기와 다를 수 있습니다.\n'
            ...
            '마음에 드는 후보가 없으면 다시 추천받기 또는 선택 안 함을 누르세요. 기존 맵과 되돌리기는 유지합니다. 넓어진 창에서 그림을 접어 채팅을 볼 수 있습니다. 재추천만 새 모델 요청을 사용합니다.\n'
