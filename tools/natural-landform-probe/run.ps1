param([string]$Run='n1',[string]$ProductDll,[string]$ProbeDll,[ValidateSet("open_basin","winding_valley","foothills","followup")][string]$Set="open_basin",[switch]$Graphics,[ValidateSet("classic","organic")][string]$Layout="classic",[string]$Evidence="2026-09-23-natural-landforms")
